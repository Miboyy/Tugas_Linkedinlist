...
int main(){
  ...
  string newData[4] = {"Ijat Kamaludin", "ijat", "ijat@gmail.com", "admin123"};
  buatdoublelinklist(newData);
  cetakDoubleLinkedList();
  string data2[4] = {"Mei Mei suka jungkok", "jungkok", "jungkokaja@gmail.com", "admin983235"};

  addFirst( data2 );
  cetakDoubleLinkedList();

  string data3[4] = {"Mael Le", "lee", "leebola@gmail.com", "Mael preman pasar"};
  addLast( data3 );
  cetakDoubleLinkedList();

  string data4[4] = {"Siti ", "Siti", "siti@yahoo.com", "admin12345"};
  addmidle(data4, 3);
  cetakDoubleLinkedList();
  removeMiddle(2);
  cetakDoubleLinkedList();
